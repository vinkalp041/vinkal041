...
const plans = [
  {
    name: "Starter",
    price: "₹3,999",
    description: "For Students / Portfolio / Simple pages",
    features: [
  ...
  },
  {
    name: "Professional",
    price: "₹8,999",
    description: "For Business / Institutes",
    features: [
      "5 pages + custom colors + forms",
  ...
  },
  {
    name: "Premium",
    price: "₹15,999+",
    description: "For Custom Brand Websites",
    features: [
      "Custom coded / WordPress",
      "Animations + SEO report",
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative bg-card border rounded-2xl p-6 lg:p-8 transition-all duration-300 hover:-translate-y-2 ${
                plan.popular 
                  ? "border-primary glow-effect scale-105 lg:scale-110" 
