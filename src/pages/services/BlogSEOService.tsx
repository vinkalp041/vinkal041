...
import { ArrowLeft, PenTool, CheckCircle, Clock, Star, Zap } from "lucide-react";
import { Link } from "react-router-dom";
import { useEffect } from "react";

const BlogSEOService = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              Blog Setup & <span className="text-gradient">SEO</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Drive organic traffic to your business with an SEO-optimized blog. Rank higher on Google and attract more potential customers.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl mx-auto bg-card border border-border rounded-3xl p-8 lg:p-12 text-center card-shadow">
            <div className="flex justify-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Star className="w-4 h-4" /> SEO Ready
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Zap className="w-4 h-4" /> Rank Higher
              </div>
            </div>
            <h3 className="text-2xl font-heading font-bold mb-2">Starting from</h3>
            <div className="text-5xl font-heading font-bold text-primary mb-4">₹4,999</div>
            <p className="text-muted-foreground mb-8">Blog setup with full SEO optimization</p>
            <a href="https://forms.gle/szcGyWgnXACAQGe86" target="_blank" rel="noopener noreferrer">
