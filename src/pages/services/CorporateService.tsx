...
import { ArrowLeft, Building, CheckCircle, Clock, Star, Zap } from "lucide-react";
...
const CorporateService = () => {
  ...
  const features = [
    ...
    "Contact with multiple locations",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              Business Corporate <span className="text-gradient">Websites</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Establish credibility and trust with a professional corporate website that showcases your company's values, services, and achievements.
            </p>
          ...
          <div className="max-w-2xl mx-auto bg-card border border-border rounded-3xl p-8 lg:p-12 text-center card-shadow">
            <div className="flex justify-center gap-4 mb-6">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Clock className="w-4 h-4" /> 7-10 Days
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Star className="w-4 h-4" /> Enterprise Grade
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <div className="text-5xl font-heading font-bold text-primary mb-4">₹9,999</div>
            <p className="text-muted-foreground mb-8">Complete corporate website with all pages</p>
            <a href="https://forms.gle/szcGyWgnXACAQGe86" target="_blank" rel="noopener noreferrer">
