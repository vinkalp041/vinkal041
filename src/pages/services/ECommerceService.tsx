...
import { ArrowLeft, ShoppingCart, CheckCircle, Clock, Star, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              E-Commerce <span className="text-gradient">Setup</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Launch your online store with full payment integration, product management, and everything you need to start selling online.
            </p>
          ...
          <div className="max-w-2xl mx-auto bg-card border border-border rounded-3xl p-8 lg:p-12 text-center card-shadow">
            <div className="flex justify-center gap-4 mb-6">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Clock className="w-4 h-4" /> 7-14 Days
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Star className="w-4 h-4" /> Full Store
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Zap className="w-4 h-4" /> Payment Ready
              </div>
            </div>
            <h3 className="text-2xl font-heading font-bold mb-2">Starting from</h3>
            <div className="text-5xl font-heading font-bold text-primary mb-4">₹12,999</div>
            <p className="text-muted-foreground mb-8">Complete store with payment integration</p>
            <a href="https://forms.gle/szcGyWgnXACAQGe86" target="_blank" rel="noopener noreferrer">
