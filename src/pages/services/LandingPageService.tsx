...
import { ArrowLeft, Layout, CheckCircle, Clock, Star, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              Landing Page <span className="text-gradient">Design</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Convert more visitors into leads and customers with high-converting landing pages designed for maximum impact and results.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl mx-auto bg-card border border-border rounded-3xl p-8 lg:p-12 text-center card-shadow">
            <div className="flex justify-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Star className="w-4 h-4" /> High Converting
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <p className="text-muted-foreground mb-8">Single page with all conversion elements</p>
            <a href="https://forms.gle/szcGyWgnXACAQGe86" target="_blank" rel="noopener noreferrer">
